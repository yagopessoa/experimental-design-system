...
var Button = function (_a) {
    ...
    return (React__default['default'].createElement(React__default['default'].Fragment, null,
        ...
        React__default['default'].createElement("button", __assign({ type: "button", className: ['storybook-button', "storybook-button--" + size, mode].join(' '), style: { backgroundColor: backgroundColor } }, props), label)));
};
...
var Header = function (_a) {
    ...
    return (React__default['default'].createElement(React__default['default'].Fragment, null,
        React__default['default'].createElement(Styles$1, null),
...
var Page = function (_a) {
    var user = _a.user, onLogin = _a.onLogin, onLogout = _a.onLogout, onCreateAccount = _a.onCreateAccount;
    return (React__default['default'].createElement(React__default['default'].Fragment, null,
        React__default['default'].createElement(Styles$2, null),
        React__default['default'].createElement("article", null,
            ...
            React__default['default'].createElement("section", null,
                ...
                React__default['default'].createElement("p", null,
                    ...
                    ' ',
                    React__default['default'].createElement("a", { href: "https://www.learnstorybook.com", target: "_blank", rel: "noopener noreferrer" }, "Learn Storybook"),
                    ". Read more in the",
                    ' ',
